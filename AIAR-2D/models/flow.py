...
class DiT(nn.Module):
    def __init__(self, config):
        ...
        self.ref_y, self.ref_x = config.model.ref_grid
        self.phy_y, self.phy_x = config.model.phy_size
        self.H_img, self.W_img = config.model.grid_size
        ...
        self.sensor_enc = nn.Sequential(
            nn.Linear(config.model.channels + 2, self.emb_dim),
